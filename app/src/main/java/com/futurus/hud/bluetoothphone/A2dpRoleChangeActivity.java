...
import com.futurus.hud.bluetoothphone.common.A2dpRoleSwitcher;
...
public class A2dpRoleChangeActivity extends Activity {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ROLE_CHANGE_CANCEL_ACTION.equals(action)) {
                ...
                if(state != BluetoothAdapter.STATE_ON) A2dpRoleChangeActivity.this.finish();
            }
        }
    };
    ...
    public void onResume() {
        ...
        filter.addAction(ROLE_CHANGE_CANCEL_ACTION);
